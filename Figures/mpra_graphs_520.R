...
ggsave(filename = file.path(plot_save_dir, 'rs5879422_mpra.png'), plot = g1, width = 70, height = 70, units = "mm", dpi = 300, device = 'png')

g2 = mpra_graph('6:117782634','rs9374663','7.53E-04')
plot_save_dir = '/data/Choi_lung/TTL/Figs_for_manuscript/Final_Figures/Sup_Figs/'
ggsave(filename = file.path(plot_save_dir, 'rs9374663_mpra.png'), plot = g2, width = 70, height = 70, units = "mm", dpi = 300, device = 'png')
