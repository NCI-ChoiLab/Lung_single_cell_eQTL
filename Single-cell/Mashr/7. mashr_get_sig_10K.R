...
res_list <- list.files("/data/Choi_lung/TTL/tensor/mashr/h5_output_Sum_Final_chr_pos/FDR/output/", recursive = TRUE, full.names = TRUE)
# res_list <- res_list[grepl("_200K.rds", res_list)]
res_list <- res_list[grepl("_10K.rds", res_list)]
...
saveRDS(msqe, "mashr_10K_qtl.rds")
...
saveRDS(msqe, "mashr_10K_sig_qtl.rds")
